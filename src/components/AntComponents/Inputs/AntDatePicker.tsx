    ...
    return (
        <div style={editMode ? {
            ...
            <ConfigProvider locale={ru_RU}>
                ...
                <Row style={{alignItems: 'center', marginBottom: '10px',width: '100%', ...cmp?.style}}>
                    ...
                    <Col span={cmp.inputWidth ? cmp.inputWidth : 14}>
                        ...
                        <div style={{position: 'relative'}}>
                            ...
                            {props.value && <DatePicker
                                ...
                                value={props.value ? moment(formatDate(props.value), DATE_FORMAT) : moment()}
                                format={[DATE_FORMAT, 'DD,MM,YYYY', 'DD/MM/YYYY', 'DD-MM-YYYY', 'DD/MM/YYYY', 'DD/MM/YY', 'DD-MM-YYYY', 'DD-MM-YY']}
                                style={{minWidth: '100%', ...cmp.inputsStyle, ...props.walidationBorderStyle}}
                                onChange={e => {
                                    props.onChange(e ? moment(e).format(DATE_FORMAT) : null)
                                }}
