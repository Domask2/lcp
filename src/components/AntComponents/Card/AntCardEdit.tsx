...
const AntCardEdit: React.FC<AndCardEditType> = ({
    ...
    }, [style, bodyStyle, headStyle, size, title, className, acl, addiction, anchor])
                    ...
                    <Col span={24}>
                        <Card className="cardEdit" size="small">
                            <Row gutter={[16, 16]}>
                                ...
                                <Col span={24}>
                                    <ItemEdit label="title" item={title} setItem={setTitle} del={false} nullable={true} type="string" labelWidth="130px" />
                                    <ItemEdit label="className" item={className} setItem={setClassName} del={false} nullable={true} type="string" labelWidth="130px" />
                                </Col>
                            </Row>
                        </Card>
