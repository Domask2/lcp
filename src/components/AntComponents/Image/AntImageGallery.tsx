...
const AntImageGallery: React.FC<AntImageType> = ({cmp, props}) => {

    // const props.dataSource = useTypedSelector((state: RootState) =>
    //     getDataSource(state, cmp.ds)
    // );

    const imageArray = props.dataSource?.items?.filter((item: any) => {
