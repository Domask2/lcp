...
import {
    ...
    setLsType,
    updateDs,
    setLsBadVarsType, dataSourceAddKeyValueType,
...
const dsActionCreators = {
    ...
    createRecordFailed: (message: string): createRecordFailedType => ({type: DsActionsEnum.CREATE_RECORD_FAILED, message}),
    ...
    deleteRecordFailed: (message: string): deleteRecordFailedType => ({type: DsActionsEnum.DELETE_RECORD_FAILED, message}),
    ...
    setLsPP: (name: string, key: string, pp_data: any): setLsPPType => ({type: DsActionsEnum.SET_LS_PP, name, key, pp_data}),
    initLsInputs: (pp_data: any): initLsInputsType => ({type: DsActionsEnum.INIT_LS_INPUTS, pp_data}),
    setLsInputs: (name: string, key: string, pp_data: any): setLsInputsType => ({type: DsActionsEnum.SET_LS_INPUTS, name, key, pp_data}),
    setLsVars: (key: string, vars_data: any): setLsVarsType => ({type: DsActionsEnum.SET_LS_VARS, key, vars_data}),
    setLsBadVars: (key: string, vars_data: any): setLsBadVarsType => ({type: DsActionsEnum.SET_LS_BAD_VARS, key, vars_data}),
    ...
    loadDataSourceFailed: (message: string): loadDataSourceFailedType => ({type: DsActionsEnum.LOAD_DATA_SOURCE_FAILED, message}),
    executeDbProcedure: (ds_key: string, payload: any, reload_ds: any): executeDbProcedure => ({type: DsActionsEnum.EXECUTE_DB_PROCEDURE, ds_key, payload, reload_ds}),
    executeDbProcedureFailed: (message: string): executeDbProcedureFailed => ({type: DsActionsEnum.EXECUTE_DB_PROCEDURE_FAILED, message}),
    executeDbProcedureSuccess: (payload: any, ds_key: string): executeDbProcedureSuccess => ({type: DsActionsEnum.EXECUTE_DB_PROCEDURE_SUCCESS, payload, ds_key}),
